...
DW_M1SA_Control_CS_T M1SA_Control_CS_DW;

/* External inputs (root inport signals with default storage) */
ExtU_M1SA_Control_CS_T M1SA_Control_CS_U;

/* External outputs (root outports fed by signals with default storage) */
ExtY_M1SA_Control_CS_T M1SA_Control_CS_Y;

/* Real-time model */
static RT_MODEL_M1SA_Control_CS_T M1SA_Control_CS_M_;
RT_MODEL_M1SA_Control_CS_T *const M1SA_Control_CS_M = &M1SA_Control_CS_M_;

/* Model step function */
void M1SA_Control_CS_step(void)
{
   ...
   */
  {
    ...
    xnew[1] = (-0.00064951930680839346)*M1SA_Control_CS_DW.Mxcontroller_DSTATE[0]
   ...
   */
  {
    ...
    xnew[1] = (-0.00064951930680839346)*M1SA_Control_CS_DW.Mycontroller_DSTATE[0]
...
void M1SA_Control_CS_initialize(void)
{
  /* Registration code */

  /* initialize error status */
  rtmSetErrorStatus(M1SA_Control_CS_M, (NULL));
...
void M1SA_Control_CS_terminate(void)
{
