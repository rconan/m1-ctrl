...
real_T OAseg_LC2CG_S3[36] = { -0.43586401604199182, -0.49853163379465776,
  ...
  1.9444035305656977 } ;               /* Variable: OAseg_LC2CG_S3
                                        * Referenced by: '<S1>/OAseg_LC2CG_S3'
                                        */

real_T OAseg_SA_dynDen_S3[2] = { 1.0, -0.53348809109110329 } ;/* Variable: OAseg_SA_dynDen_S3
                                                            * Referenced by: '<S1>/OAseg_SA_dyn'
                                                            */

real_T OAseg_SA_dynNum_S3[2] = { 0.25752323685913081, 0.20898867204976596 } ;/* Variable: OAseg_SA_dynNum_S3
                                                                      * Referenced by: '<S1>/OAseg_SA_dyn'
                                                                      */
...
void M1SA_F_Control_S3_initialize(void)
{
  ...
  /* external outputs */
  (void) memset(&M1SA_F_Control_S3_Y.Res_Act_F[0], 0,
                335U*sizeof(real_T));
}
