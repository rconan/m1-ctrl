...
void M1SA_F_Control_S3_step(void)
{
  ...
  /* DiscreteStateSpace: '<S2>/Fx controller' */
  {
    rtb_Fxcontroller = (5.5100401607158833)*
      ...
      + (-5.0303630344232824)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[1]
  ...
  /* DiscreteStateSpace: '<S2>/Fy controller' */
  {
    rtb_Fycontroller = (5.5100401607158833)*
      ...
      + (-5.0303630344232824)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[1]
  ...
  /* DiscreteStateSpace: '<S2>/Fz controller' */
  {
    rtb_Fzcontroller = (-10.950108858889026)*
      ...
      + (14.571154350139892)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[1]
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.58443008685641118)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[0]
      + (0.67252934225212191)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[1]
      + (-0.048965038524629384)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[2];
    xnew[0] += (-0.0016734052711992048)*rtb_LC2CG[0];
    xnew[1] = (-0.2254136550158379)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[0]
      + (0.62520960147916238)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[1]
      + (0.096979099095789667)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.58443008685641118)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[0]
      + (0.67252934225212191)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[1]
      + (-0.048965038524629384)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[2];
    xnew[0] += (-0.0016734052711992048)*rtb_LC2CG[1];
    xnew[1] = (-0.2254136550158379)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[0]
      + (0.62520960147916238)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[1]
      + (0.096979099095789667)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.32224501051155652)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[0]
      + (-0.013311547842537925)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[1]
      + (0.13574136089816072)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[2];
    xnew[0] += (0.0051358870792095942)*rtb_LC2CG[2];
    xnew[1] = (0.66124884843011622)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[0]
      + (0.13460444259831872)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[1]
      + (-0.0021534473090368935)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[2];
