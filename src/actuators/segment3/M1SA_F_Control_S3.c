...
ExtY_M1SA_F_Control_S3_T M1SA_F_Control_S3_Y;

/* Real-time model */
RT_MODEL_M1SA_F_Control_S3_T M1SA_F_Control_S3_M_;
RT_MODEL_M1SA_F_Control_S3_T *const M1SA_F_Control_S3_M = &M1SA_F_Control_S3_M_;

/* Model step function */
void M1SA_F_Control_S3_step(void)
{
  ...
  for (k = 0; k < 27; k++) {
    memOffset_tmp = k << 1;
    denAccum_tmp = M1SA_F_Control_S3_DW.SADynamics_states[memOffset_tmp + 1];
    denAccum = (M1SA_F_Control_S3_U.BM_cmd[k] - -0.77932227475069393 *
                M1SA_F_Control_S3_DW.SADynamics_states[memOffset_tmp]) -
  ...
  for (k = 0; k < 6; k++) {
    ...
    memOffset_tmp = 0;
    for (i = 0; i < 6; i++) {
      rtb_LC2CG[k] += M1SA_F_Control_S3_ConstP.LC2CG_Gain[memOffset_tmp + k] *
        M1SA_F_Control_S3_U.HP_LC[i];
      memOffset_tmp += 6;
    }
  }
  ...
  /* DiscreteStateSpace: '<S2>/Fx controller' */
  {
    rtb_Fxcontroller = (6.5598720805159942)*
      ...
      + (-5.94467376914989)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[1]
      + (1.5)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[2];
  ...
  /* DiscreteStateSpace: '<S2>/Fy controller' */
  {
    rtb_Fycontroller = (6.5598720805159942)*
      ...
      + (-5.94467376914989)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[1]
      + (1.5)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[2];
  ...
  /* DiscreteStateSpace: '<S2>/Fz controller' */
  {
    rtb_Fzcontroller = (11.530556837169614)*
      ...
      + (-10.851053072456448)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[1]
      + (2.5)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[2];
  ...
  {
    {
      ...
      const real_T *pC0 = M1SA_F_Control_S3_ConstP.pooled10;
      const real_T *xd = &M1SA_F_Control_S3_DW.Mxcontroller_DSTATE[0];
  ...
  {
    {
      ...
      const int_T *pCidx = &colCidxRow0[0];
      const real_T *pC0 = M1SA_F_Control_S3_ConstP.pooled10;
      const real_T *xd = &M1SA_F_Control_S3_DW.Mycontroller_DSTATE[0];
  ...
  /* DiscreteStateSpace: '<S2>/Mz controller' */
  {
    rtb_Mzcontroller = (-20.532898991147984)*
      ...
      + (6.3249300064723526)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[1]
      + (2.5)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[2];
  ...
  for (k = 0; k < 6; k++) {
    memOffset_tmp = k << 1;
    denAccum_tmp = M1SA_F_Control_S3_DW.SADynamicsS1_states[memOffset_tmp + 1];
    denAccum = (rtb_TmpSignalConversionAtSADynamicsS1Inport1[k] -
                -0.77932227475069393 *
                M1SA_F_Control_S3_DW.SADynamicsS1_states[memOffset_tmp]) -
      denAccum_tmp * 0.15183580198064905;
  ...
  for (k = 0; k < 335; k++) {
    ...
    for (memOffset_tmp = 0; memOffset_tmp < 6; memOffset_tmp++) {
      tmp[k] += M1SA_F_Control_S3_ConstP.ForcebalanceS1_Gain[335 * memOffset_tmp
    ...
    for (memOffset_tmp = 0; memOffset_tmp < 27; memOffset_tmp++) {
      tmp_0[k] += M1SA_F_Control_S3_ConstP.BM2Forces_Gain[335 * memOffset_tmp +
     ...
     *  Sum: '<S1>/Add'
     */
    M1SA_F_Control_S3_Y.M1_ACT_F[k] = tmp[k] + tmp_0[k];
  }

  /* Update for DiscreteTransferFcn: '<S1>/SA Dynamics' */
  for (k = 0; k < 27; k++) {
    memOffset_tmp = k << 1;
    M1SA_F_Control_S3_DW.SADynamics_states[memOffset_tmp - -1] =
      M1SA_F_Control_S3_DW.SADynamics_states[memOffset_tmp];
    M1SA_F_Control_S3_DW.SADynamics_states[memOffset_tmp] = SADynamics_tmp[k];
  }
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.47684153921414885)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[0]
      + (0.68480541865093592)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[1]
      + (-0.051399221529844809)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[2];
    xnew[0] += (-0.0017355509321005055)*rtb_LC2CG[0];
    xnew[1] = (-0.0016575308145891927)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE
      [0]
      + (0.54422361645762907)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[1]
      + (0.11154561057231037)*M1SA_F_Control_S3_DW.Fxcontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.47684153921414885)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[0]
      + (0.68480541865093592)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[1]
      + (-0.051399221529844809)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[2];
    xnew[0] += (-0.0017355509321005055)*rtb_LC2CG[1];
    xnew[1] = (-0.0016575308145891927)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE
      [0]
      + (0.54422361645762907)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[1]
      + (0.11154561057231037)*M1SA_F_Control_S3_DW.Fycontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.24588323456423122)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[0]
      + (0.7046784245026928)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[1]
      + (0.0010918487408774443)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[2];
    xnew[0] += (0.00026134526724467871)*rtb_LC2CG[2];
    xnew[1] = (-0.00064951930680838814)*
      M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[0]
      + (0.28867118809350589)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[1]
      + (0.15553729939777869)*M1SA_F_Control_S3_DW.Fzcontroller_DSTATE[2];
  ...
  /* Update for DiscreteStateSpace: '<S2>/Mx controller' */
  {
...

    {
      ...
      const real_T *pA0 = M1SA_F_Control_S3_ConstP.pooled8;
      const real_T *xd = &M1SA_F_Control_S3_DW.Mxcontroller_DSTATE[0];
...

    {
      ...
      const real_T *pA5 = &M1SA_F_Control_S3_ConstP.pooled8[5];
      const real_T *xd = &M1SA_F_Control_S3_DW.Mxcontroller_DSTATE[0];
...

    {
      ...
      const real_T *pA10 = &M1SA_F_Control_S3_ConstP.pooled8[10];
      const real_T *xd = &M1SA_F_Control_S3_DW.Mxcontroller_DSTATE[0];
...

    {
      ...
      const real_T *pA15 = &M1SA_F_Control_S3_ConstP.pooled8[15];
      const real_T *xd = &M1SA_F_Control_S3_DW.Mxcontroller_DSTATE[0];
    ...
    xnew[4] = (1.0)*M1SA_F_Control_S3_DW.Mxcontroller_DSTATE[4];
  ...
  /* Update for DiscreteStateSpace: '<S2>/My controller' */
  {
    ...
    xnew[4] = (1.0)*M1SA_F_Control_S3_DW.Mycontroller_DSTATE[4];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.027853439610535102)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[0]
      + (0.4384495239533896)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[1]
      + (0.05976437398581852)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[2];
    xnew[0] += (0.0022548103799476128)*rtb_LC2CG[5];
    xnew[1] = (0.025863212654755947)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[0]
      + (0.70999971403230988)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[1]
      + (-0.121271115438719)*M1SA_F_Control_S3_DW.Mzcontroller_DSTATE[2];
  ...
  for (k = 0; k < 6; k++) {
    memOffset_tmp = k << 1;
    M1SA_F_Control_S3_DW.SADynamicsS1_states[memOffset_tmp - -1] =
      M1SA_F_Control_S3_DW.SADynamicsS1_states[memOffset_tmp];
    M1SA_F_Control_S3_DW.SADynamicsS1_states[memOffset_tmp] = SADynamicsS1_tmp[k];
  }
...
void M1SA_F_Control_S3_initialize(void)
{
  /* Registration code */
  ...
  /* external outputs */
  (void) memset(&M1SA_F_Control_S3_Y.M1_ACT_F[0], 0,
                335U*sizeof(real_T));
}

/* Model terminate function */
void M1SA_F_Control_S3_terminate(void)
{
