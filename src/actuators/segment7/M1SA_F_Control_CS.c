...
void M1SA_F_Control_CS_step(void)
{
  ...
  /* DiscreteStateSpace: '<S2>/Fx controller' */
  {
    rtb_Fxcontroller = (6.5598720805159942)*
      ...
      + (-5.94467376914989)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE[1]
      + (1.5)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE[2];
  ...
  /* DiscreteStateSpace: '<S2>/Fy controller' */
  {
    rtb_Fycontroller = (6.5598720805159942)*
      ...
      + (-5.94467376914989)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE[1]
      + (1.5)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE[2];
  ...
  /* DiscreteStateSpace: '<S2>/Fz controller' */
  {
    rtb_Fzcontroller = (11.530556837169614)*
      ...
      + (-10.851053072456448)*M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[1]
      + (2.5)*M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[2];
  ...
  {
    {
      ...
      const real_T *pC0 = M1SA_F_Control_CS_ConstP.pooled10;
      const real_T *xd = &M1SA_F_Control_CS_DW.Mxcontroller_DSTATE[0];
  ...
  {
    {
      ...
      const int_T *pCidx = &colCidxRow0[0];
      const real_T *pC0 = M1SA_F_Control_CS_ConstP.pooled10;
      const real_T *xd = &M1SA_F_Control_CS_DW.Mycontroller_DSTATE[0];
  ...
  /* DiscreteStateSpace: '<S2>/Mz controller' */
  {
    rtb_Mzcontroller = (-20.532898991147984)*
      ...
      + (6.3249300064723526)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[1]
      + (2.5)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.47684153921414885)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE[0]
      + (0.68480541865093592)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE[1]
      + (-0.051399221529844809)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE[2];
    xnew[0] += (-0.0017355509321005055)*rtb_LC2CG[0];
    xnew[1] = (-0.0016575308145891927)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE
      [0]
      + (0.54422361645762907)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE[1]
      + (0.11154561057231037)*M1SA_F_Control_CS_DW.Fxcontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.47684153921414885)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE[0]
      + (0.68480541865093592)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE[1]
      + (-0.051399221529844809)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE[2];
    xnew[0] += (-0.0017355509321005055)*rtb_LC2CG[1];
    xnew[1] = (-0.0016575308145891927)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE
      [0]
      + (0.54422361645762907)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE[1]
      + (0.11154561057231037)*M1SA_F_Control_CS_DW.Fycontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.24588323456423122)*M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[0]
      + (0.7046784245026928)*M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[1]
      + (0.0010918487408774443)*M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[2];
    xnew[0] += (0.00026134526724467871)*rtb_LC2CG[2];
    xnew[1] = (-0.00064951930680838814)*
      M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[0]
      + (0.28867118809350589)*M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[1]
      + (0.15553729939777869)*M1SA_F_Control_CS_DW.Fzcontroller_DSTATE[2];
  ...
  /* Update for DiscreteStateSpace: '<S2>/Mx controller' */
  {
...

    {
      ...
      const real_T *pA0 = M1SA_F_Control_CS_ConstP.pooled8;
      const real_T *xd = &M1SA_F_Control_CS_DW.Mxcontroller_DSTATE[0];
...

    {
      ...
      const real_T *pA5 = &M1SA_F_Control_CS_ConstP.pooled8[5];
      const real_T *xd = &M1SA_F_Control_CS_DW.Mxcontroller_DSTATE[0];
...

    {
      ...
      const real_T *pA10 = &M1SA_F_Control_CS_ConstP.pooled8[10];
      const real_T *xd = &M1SA_F_Control_CS_DW.Mxcontroller_DSTATE[0];
...

    {
      ...
      const real_T *pA15 = &M1SA_F_Control_CS_ConstP.pooled8[15];
      const real_T *xd = &M1SA_F_Control_CS_DW.Mxcontroller_DSTATE[0];
    ...
    xnew[4] = (1.0)*M1SA_F_Control_CS_DW.Mxcontroller_DSTATE[4];
  ...
  /* Update for DiscreteStateSpace: '<S2>/My controller' */
  {
    ...
    xnew[4] = (1.0)*M1SA_F_Control_CS_DW.Mycontroller_DSTATE[4];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.027853439610535102)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[0]
      + (0.4384495239533896)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[1]
      + (0.05976437398581852)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[2];
    xnew[0] += (0.0022548103799476128)*rtb_LC2CG[5];
    xnew[1] = (0.025863212654755947)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[0]
      + (0.70999971403230988)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[1]
      + (-0.121271115438719)*M1SA_F_Control_CS_DW.Mzcontroller_DSTATE[2];
