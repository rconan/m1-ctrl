...
void M1SA_F_Control_S5_step(void)
{
  ...
  for (i = 0; i < 6; i++) {
    ...
    i_1 = 0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_OAseg_LC2CG_S5[i] += OAseg_LC2CG_S5[i_1 + i] * M1SA_F_Control_S5_U.HP_LC[i_0];
      i_1 += 6;
    }
  }
  ...
  /* DiscreteStateSpace: '<S3>/Fx controller' */
  {
    rtb_Fxcontroller = (-6.8610656930319749)*
      ...
      + (8.7455483888425327)*M1SA_F_Control_S5_DW.Fxcontroller_DSTATE[1]
  ...
  /* DiscreteStateSpace: '<S3>/Fy controller' */
  {
    rtb_Fycontroller = (-6.8610656930319749)*
      ...
      + (8.7455483888425327)*M1SA_F_Control_S5_DW.Fycontroller_DSTATE[1]
  ...
  /* DiscreteStateSpace: '<S3>/Fz controller' */
  {
    rtb_Fzcontroller = (-11.022867857707155)*
      ...
      + (14.667973716577512)*M1SA_F_Control_S5_DW.Fzcontroller_DSTATE[1]
  ...
  for (i_0 = 0; i_0 < 335; i_0++) {
    ...
    i = 0;
    for (i_1 = 0; i_1 < 6; i_1++) {
      OFL_act_Fcmd[i_0] += M1SA_F_Control_S5_ConstP.OAseg_Kbal_Gain[i + i_0] *
        tmp[i_1];
      i += 335;
    }
    ...
    denAccum = (OFL_act_Fcmd[i_0] + M1SA_F_Control_S5_U.SA_offsetF_cmd[i_0]) -
      OAseg_SA_dynDen_S5[1] * M1SA_F_Control_S5_DW.OAseg_SA_dyn_states[i_0];
    OAseg_SA_dyn_tmp[i_0] = denAccum;
    denAccum *= OAseg_SA_dynNum_S5[0];

    /* Outport: '<Root>/Res_Act_F' incorporates:
     *  DiscreteTransferFcn: '<S1>/OAseg_SA_dyn'
     *  Gain: '<S1>/OAseg_Kbal'
     */
    M1SA_F_Control_S5_Y.Res_Act_F[i_0] = OAseg_SA_dynNum_S5[1] *
      M1SA_F_Control_S5_DW.OAseg_SA_dyn_states[i_0] + denAccum;
  }

  /* Update for DiscreteStateSpace: '<S3>/Fx controller' */
  {
    real_T xnew[3];
    xnew[0] = (0.569006949265765)*M1SA_F_Control_S5_DW.Fxcontroller_DSTATE[0]
      + (-0.01008281122133318)*M1SA_F_Control_S5_DW.Fxcontroller_DSTATE[1]
      + (0.10624490391424918)*M1SA_F_Control_S5_DW.Fxcontroller_DSTATE[2];
    xnew[0] += (0.0041005206649182965)*rtb_OAseg_LC2CG_S5[0];
    xnew[1] = (0.69153586838988734)*M1SA_F_Control_S5_DW.Fxcontroller_DSTATE[0]
      + (0.40200245095801357)*M1SA_F_Control_S5_DW.Fxcontroller_DSTATE[1]
      + (-0.053834780381561045)*M1SA_F_Control_S5_DW.Fxcontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.569006949265765)*M1SA_F_Control_S5_DW.Fycontroller_DSTATE[0]
      + (-0.01008281122133318)*M1SA_F_Control_S5_DW.Fycontroller_DSTATE[1]
      + (0.10624490391424918)*M1SA_F_Control_S5_DW.Fycontroller_DSTATE[2];
    xnew[0] += (0.0041005206649182965)*rtb_OAseg_LC2CG_S5[1];
    xnew[1] = (0.69153586838988734)*M1SA_F_Control_S5_DW.Fycontroller_DSTATE[0]
      + (0.40200245095801357)*M1SA_F_Control_S5_DW.Fycontroller_DSTATE[1]
      + (-0.053834780381561045)*M1SA_F_Control_S5_DW.Fycontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.3222450105115563)*M1SA_F_Control_S5_DW.Fzcontroller_DSTATE[0]
      + (-0.013311547842537916)*M1SA_F_Control_S5_DW.Fzcontroller_DSTATE[1]
      + (0.13664330677325981)*M1SA_F_Control_S5_DW.Fzcontroller_DSTATE[2];
    xnew[0] += (0.005170012950170496)*rtb_OAseg_LC2CG_S5[2];
    xnew[1] = (0.66124884843011622)*M1SA_F_Control_S5_DW.Fzcontroller_DSTATE[0]
      + (0.13460444259831861)*M1SA_F_Control_S5_DW.Fzcontroller_DSTATE[1]
      + (-0.0021677560864410391)*M1SA_F_Control_S5_DW.Fzcontroller_DSTATE[2];
  ...
  memcpy(&M1SA_F_Control_S5_DW.OAseg_SA_dyn_states[0], &OAseg_SA_dyn_tmp[0],
         335U * sizeof(real_T));
}
