 ...
 *
 */
extern real_T OAseg_LC2CG_S4[36];         /* Variable: OAseg_LC2CG_S4
                                        * Referenced by: '<S1>/OAseg_LC2CG_S4'
                                        */
extern real_T OAseg_SA_dynDen_S4[2];      /* Variable: OAseg_SA_dynDen_S4
                                        * Referenced by: '<S1>/OAseg_SA_dyn'
                                        */
extern real_T OAseg_SA_dynNum_S4[2];      /* Variable: OAseg_SA_dynNum_S4
                                        * Referenced by: '<S1>/OAseg_SA_dyn'
                                        */
 ...
 * '<S2>'   : 'M1DCS/M1SA_F_Control_S4/OAseg_ofl_SSdtC'
 * '<S3>'   : 'M1DCS/M1SA_F_Control_S4/OAseg_ofl_SSdtC_'
 */
