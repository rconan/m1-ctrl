...
void M1SA_F_Control_OA_step(void)
{
  ...
  for (i = 0; i < 6; i++) {
    ...
    i_1 = 0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_LC2CG[i] += M1SA_F_Control_OA_ConstP.LC2CG_Gain[i_1 + i] *
  ...
  /* DiscreteStateSpace: '<S2>/Fx controller' */
  {
    rtb_Fxcontroller = (5.5100401607158833)*
      ...
      + (-5.0303630344232824)*M1SA_F_Control_OA_DW.Fxcontroller_DSTATE[1]
  ...
  /* DiscreteStateSpace: '<S2>/Fy controller' */
  {
    rtb_Fycontroller = (5.5100401607158833)*
      ...
      + (-5.0303630344232824)*M1SA_F_Control_OA_DW.Fycontroller_DSTATE[1]
  ...
  /* DiscreteStateSpace: '<S2>/Fz controller' */
  {
    rtb_Fzcontroller = (-10.950108858889026)*
      ...
      + (14.571154350139892)*M1SA_F_Control_OA_DW.Fzcontroller_DSTATE[1]
  ...
  for (i_0 = 0; i_0 < 335; i_0++) {
    ...
    i = 0;
    for (i_1 = 0; i_1 < 6; i_1++) {
      rtb_SADynamicsS1[i_0] += M1SA_F_Control_OA_ConstP.ForcebalanceS1_Gain[i +
        i_0] * tmp[i_1];
      i += 335;
    }
     ...
     *  Sum: '<S1>/Add'
     */
    denAccum = (rtb_SADynamicsS1[i_0] + M1SA_F_Control_OA_U.SA_offsetF_cmd[i_0])
      - -0.53348809109110329 * M1SA_F_Control_OA_DW.SADynamicsS1_states[i_0];
    SADynamicsS1_tmp[i_0] = denAccum;
    denAccum *= 0.25752323685913081;
    rtb_SADynamicsS1[i_0] = 0.20898867204976596 *
      M1SA_F_Control_OA_DW.SADynamicsS1_states[i_0] + denAccum;

    /* Outport: '<Root>/M1_ACT_F' incorporates:
     *  Gain: '<S1>/Force balance S1'
     */
    M1SA_F_Control_OA_Y.M1_ACT_F[i_0] = rtb_SADynamicsS1[i_0];
  }

  /* Update for DiscreteStateSpace: '<S2>/Fx controller' */
  {
    real_T xnew[3];
    xnew[0] = (0.58443008685641118)*M1SA_F_Control_OA_DW.Fxcontroller_DSTATE[0]
      + (0.67252934225212191)*M1SA_F_Control_OA_DW.Fxcontroller_DSTATE[1]
      + (-0.048965038524629384)*M1SA_F_Control_OA_DW.Fxcontroller_DSTATE[2];
    xnew[0] += (-0.0016734052711992048)*rtb_LC2CG[0];
    xnew[1] = (-0.2254136550158379)*M1SA_F_Control_OA_DW.Fxcontroller_DSTATE[0]
      + (0.62520960147916238)*M1SA_F_Control_OA_DW.Fxcontroller_DSTATE[1]
      + (0.096979099095789667)*M1SA_F_Control_OA_DW.Fxcontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.58443008685641118)*M1SA_F_Control_OA_DW.Fycontroller_DSTATE[0]
      + (0.67252934225212191)*M1SA_F_Control_OA_DW.Fycontroller_DSTATE[1]
      + (-0.048965038524629384)*M1SA_F_Control_OA_DW.Fycontroller_DSTATE[2];
    xnew[0] += (-0.0016734052711992048)*rtb_LC2CG[1];
    xnew[1] = (-0.2254136550158379)*M1SA_F_Control_OA_DW.Fycontroller_DSTATE[0]
      + (0.62520960147916238)*M1SA_F_Control_OA_DW.Fycontroller_DSTATE[1]
      + (0.096979099095789667)*M1SA_F_Control_OA_DW.Fycontroller_DSTATE[2];
  ...
  {
    real_T xnew[3];
    xnew[0] = (0.32224501051155652)*M1SA_F_Control_OA_DW.Fzcontroller_DSTATE[0]
      + (-0.013311547842537925)*M1SA_F_Control_OA_DW.Fzcontroller_DSTATE[1]
      + (0.13574136089816072)*M1SA_F_Control_OA_DW.Fzcontroller_DSTATE[2];
    xnew[0] += (0.0051358870792095942)*rtb_LC2CG[2];
    xnew[1] = (0.66124884843011622)*M1SA_F_Control_OA_DW.Fzcontroller_DSTATE[0]
      + (0.13460444259831872)*M1SA_F_Control_OA_DW.Fzcontroller_DSTATE[1]
      + (-0.0021534473090368935)*M1SA_F_Control_OA_DW.Fzcontroller_DSTATE[2];
  ...
  memcpy(&M1SA_F_Control_OA_DW.SADynamicsS1_states[0], &SADynamicsS1_tmp[0],
         335U * sizeof(real_T));
}
